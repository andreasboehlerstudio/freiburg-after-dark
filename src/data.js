...
export const LEVELS = [
 { id:'kajo', worldKey:'martinstor', name:'Kaiser-Joseph-Straße', subtitle:'01 · Nachtschicht am Martinstor', landmark:'Martinstor', width:4600, ground:'#494958', sky:'#22253e', accent:'#ffa764', boss:'Dr. Rendite', bossType:'broker', waves:[[3,4],[4,4],[4,5],[4,1]], atmosphere:'Warme Schaufenster, Straßenbahnschienen, Bächle und das Martinstor.', bossLine:'Die Stadt gehört allen. Seine Rechnung geht heute nicht auf.' },
 { id:'stuehlinger', worldKey:'stuehlinger', name:'Stühlinger', subtitle:'02 · Hinter den Gleisen', landmark:'Radstation', width:4600, ground:'#444f58', sky:'#132c3b', accent:'#63d8dc', boss:'Der Pate vom Hinterhof', bossType:'enforcer', waves:[[4,4],[4,5],[5,5],[4,1]], atmosphere:'Altbaufassaden, Werkstätten, Fahrräder und die runde Radstation.', bossLine:'Schutzgeld? Heute übernimmt die Straße den Kundendienst.' },
 { id:'park', worldKey:'park', name:'Stühlinger Park', subtitle:'03 · Unter den Türmen', landmark:'Herz-Jesu-Kirche', width:4600, ground:'#34483f', sky:'#152c39', accent:'#afe084', boss:'Beton-Baron', bossType:'baron', waves:[[4,5],[5,5],[5,6],[5,1]], atmosphere:'Baumreihen, Parkbänke und die türkisen Türme der Herz-Jesu-Kirche.', bossLine:'Auch ein Immobilienkönig muss irgendwann zu Fuß nach Hause.' },
 { id:'haslach', worldKey:'haslach', name:'Haslach / Weingarten', subtitle:'04 · Kein Durchgang', landmark:'Haslach / Weingarten', width:4600, ground:'#39424d', sky:'#172731', accent:'#ed9164', boss:'Der Pförtner', bossType:'enforcer', bossStats:{hp:660,speed:144,power:25}, enemyHealthScale:1.28, enemyRoster:['hooligan','enforcer','runner','extremist'], foodEvery:6, arenaHeal:14, waves:[[4,5],[5,5],[5,6],[5,1]], atmosphere:'Tramtrassen, Wohnblöcke und Hinterhöfe zwischen Haslach und Weingarten.', bossLine:'Seine Wachtruppe sperrt die Straße. Ihr macht sie wieder frei.' },
 { id:'wiehre', worldKey:'wiehre', name:'Wiehre / Alter Wiehrebahnhof', subtitle:'05 · Die letzte Verbindung', landmark:'Alter Wiehrebahnhof', width:4600, ground:'#42474b', sky:'#1c2833', accent:'#e8bb79', boss:'Der Nachtkassierer', bossType:'broker', bossStats:{hp:720,speed:150,power:27}, enemyHealthScale:1.34, enemyRoster:['suit','runner','extremist','enforcer'], foodEvery:6, arenaHeal:14, waves:[[5,5],[5,6],[5,6],[5,1]], atmosphere:'Der alte Bahnhof, ruhige Seitenstraßen und warme Fenster im nächtlichen Regen.', bossLine:'Seine Handlanger kassieren an jeder Ecke. Ihr beendet die Schicht.' },
 { id:'bermuda', worldKey:'bermuda', name:'Bermuda-Dreieck / Martinstor', subtitle:'06 · Die letzte Tür', landmark:'Martinstor / Bermuda-Dreieck', width:4600, ground:'#3f3947', sky:'#191e32', accent:'#f04a53', boss:'Die Mähne', bossType:'bouncer', bossStats:{hp:820,speed:138,power:29,range:125,telegraph:1.0}, enemyHealthScale:1.4, enemyRoster:['extremist','enforcer','suit','hooligan'], foodEvery:6, arenaHeal:16, waves:[[5,5],[6,5],[6,6],[5,1]], atmosphere:'Enge Altstadtgassen, rote Clublichter und das Martinstor über dem Bermuda-Dreieck.', bossLine:'Eine letzte Clubtür. Ein riesiger Türsteher mit wilder Mähne. Eure Stadt wartet.' },
];
